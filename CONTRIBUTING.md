...
-   Open an
    [**Issue**](https://github.com/Archoleat/browtest/issues/new/choose).
...
-   To see if other users have experienced (and potentially already solved)
    ...
    [**bug tracker**](https://github.com/Archoleat/browtest/issues?q=label%3Abug).
...
-   Perform a
    [**search**](https://github.com/Archoleat/browtest/issues)
...
Enhancement suggestions are tracked as [**GitHub Issues**](https://github.com/Archoleat/browtest/issues/new/choose).
